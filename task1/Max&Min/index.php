...
if ($_POST) {
  ...
  "<div class='alert alert-danger'> 
     Their is more than one value selected  
</div>";
}     
}
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-4 offset-4">
        <form method="post">
          <div class="mb-3">
            <input type="number" class="form-control" id="Num" name="First_Num" placeholder=" Enter First Number">
          </div>
          <div class="mb-3">
            <input type="number" class="form-control" id="Num" name="Second_Num" placeholder=" Enter Second Number">
          </div>
          <div class="mb-3">
            <input type="number" class="form-control" id="Num" name="Third_Num" placeholder=" Enter Third Number">
          </div>
